...
<ol id="4TI">
    ...
    <li id="4TI-2">
    Check that captions are accurate and include all dialogue and equivalents for non-dialogue audio information needed to understand the program content, including sound effects, music, laughter, speaker identification and location. [SC 1.2.2]
        <ol>
...
<ol id="6TI">
    ...
    <li id="6TI-2">
    Check that provided captions include dialogue and important sounds. [SC 1.2.4]
        <ol>
