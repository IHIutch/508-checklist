...
<ol id="1TI">
    ...
    <li id="1TI-2">
    If the content flashes above 3Hz or the frequency cannot be determined, check that it meets one of the following: [SC 2.3.1]
    <ol>
        ...
        <li id="1TI-2ii">
        The opposing transitions that flash do not involve a saturated red AND
        <ol>
